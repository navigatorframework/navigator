    ...
    public Task<UpdateCategory> Process(Update update)
    {
        return Task.FromResult(update.Type switch
        {
            ...
            UpdateType.Message => update.Message?.Type switch
            {
                ...
                MessageType.MessageAutoDeleteTimerChanged => new UpdateCategory(nameof(MessageType), nameof(MessageType.MessageAutoDeleteTimerChanged)),
                ...
                MessageType.VideoChatParticipantsInvited => new UpdateCategory(nameof(MessageType), nameof(MessageType.VideoChatParticipantsInvited)),
                ...
                MessageType.GeneralForumTopicUnhidden => new UpdateCategory(nameof(MessageType), nameof(MessageType.GeneralForumTopicUnhidden)),
